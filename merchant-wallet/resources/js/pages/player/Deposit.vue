...
const isValid = computed(() => {
    return (
        ...
        (form.payment_method === 'duitnowqr' || form.bank !== '')
    );
});
...
async function loadData() {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            loadError.value =
                body?.message ??
                'Could not load deposit options. Please try again.';
...
useTour('player-deposit', [
    ...
    },
    {
        ...
        popover: {
            ...
            description:
                'Submit to be taken to the payment gateway and complete your top-up.',
        },
    },
]);
    ...
    <PlayerShell active="deposit" eyebrow="Wallet" title="Deposit">
        <div class="layout">
            <section class="panel">
                <div class="panel-head">
                    ...
                    <p class="panel-sub muted">
                        Choose a method and amount to top up your wallet.
                    </p>
                </div>
            ...
            <aside class="side-card">
                ...
                <div class="side-note">
                    You'll be redirected to the gateway to complete payment
                    securely.
                </div>
            </aside>
        </div>
