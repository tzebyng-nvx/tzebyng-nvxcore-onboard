            ...
            <div class="form-card">
                ...
                <form @submit.prevent="submit" novalidate>
                    <div class="field">
                        ...
                        />
                        <p v-if="fieldError('name')" class="error">
                            {{ fieldError('name') }}
                        </p>
                    </div>
                    ...
                    <div class="field">
                        ...
                        />
                        <p v-if="fieldError('email')" class="error">
                            {{ fieldError('email') }}
                        </p>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <input
                            ...
                            autocomplete="tel"
                            :class="{
                                'is-invalid': fieldError('phone_number'),
                            }"
                        />
                        <p v-if="fieldError('phone_number')" class="error">
                    ...
                    <div class="field">
                        ...
                        />
                        <p v-if="fieldError('password')" class="error">
                            {{ fieldError('password') }}
                        </p>
                    </div>
